...
- Marked for deletion and playback issue are the exceptions: the thumbnail goes fully grey
...
| Legend footnote | `Click cycles through the slots. Right-click a tag for its menu.` |
