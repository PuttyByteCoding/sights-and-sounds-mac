...
@Suite struct LibraryStoreTests {
    ...
    @Test func migrationsApplyAndPersist() throws {
        ...
        #expect(try first.appliedMigrations() == ["phase0", "phase1", "phase2", "phase4", "phase5", "phase6", "phase7", "phase7b", "phase7c", "phase7d", "phase8", "phase8b", "extensionOverrides", "categoryColors", "segmentRoles", "categoryDisplayStyle", "importBoxes", "jobPriority", "playbackIssueEvidence", "moveSessions", "separatorCharacters"])
        ...
        #expect(try second.appliedMigrations() == ["phase0", "phase1", "phase2", "phase4", "phase5", "phase6", "phase7", "phase7b", "phase7c", "phase7d", "phase8", "phase8b", "extensionOverrides", "categoryColors", "segmentRoles", "categoryDisplayStyle", "importBoxes", "jobPriority", "playbackIssueEvidence", "moveSessions", "separatorCharacters"])
