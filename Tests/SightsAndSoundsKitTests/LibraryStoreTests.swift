...
@Suite struct LibraryStoreTests {
    ...
    @Test func migrationsApplyAndPersist() throws {
        ...
        #expect(try first.appliedMigrations() == ["phase0", "phase1", "phase2", "phase4", "phase5", "phase6", "phase7", "phase7b"])
        ...
        #expect(try second.appliedMigrations() == ["phase0", "phase1", "phase2", "phase4", "phase5", "phase6", "phase7", "phase7b"])
